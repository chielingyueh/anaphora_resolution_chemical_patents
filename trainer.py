...
class Trainer(object):
    ...
    def evaluate(self, mode):
        ...
        if mode == "test":
            ...
            raise Exception("Only dev and test and train dataset available")
        ...
        write_prediction(self.args, os.path.join(self.args.eval_dir, f"proposed_answers_{self.args.model_name_log}-{mode}.txt"), preds)
