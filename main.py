...
def main(args):
    ...
    log_script_arguments(logger, args)
...
if __name__ == "__main__":
    ...
    parser.add_argument("--fold", default="test", type=str, help="The fold number")
    parser.add_argument("--model_name_log", default="bert-base-uncased", type=str, help="The name of model for log-file name")
